      ...
      rowEdit: function($row) {
        ...
        $row.children('td').each(function(i) {
          ...
          if ($this.hasClass('actions')) {
			...
			if(i == 0) { 
			  $this.html('<input type="number" id="' + i + '" class="form-control input-normal" style="width: 80px;" value="' + data[i] + '"/>');
              idAction = data[i];
			} else if(i == 2) {
			  $this.html('<select  id="selectStatus" class="form-control" style="width: 100%;" data-plugin="select">' + rowStatusAgvs() + '</select>');
              valueStatus = data[i];
			} else if(i == 3) {
			  $this.html('<select  id="selectTipo" class="form-control" style="width: 100%;" data-plugin="select">' + rowTipoAGVS() + '</select>');	
              valueTipo = data[i];
			} else {
