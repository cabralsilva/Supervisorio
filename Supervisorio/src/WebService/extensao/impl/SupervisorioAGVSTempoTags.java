...
public class SupervisorioAGVSTempoTags implements Command{

	private ConvertPAGinHTML cph;
	private String[] files = {PathFilesPAG.cadastroAGVSTempoTags};
	...
	public void execute(Request req, Response resp) throws Exception {
		...
		if(!Login.login(req, resp, Login.tokenCadastroTempoTags)) {
		...
		tags.add(Keys.keyGerarTabelaTempoTags, mt.methodGerarTabelaTempoTags);
